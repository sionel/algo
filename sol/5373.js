    ...
    switch (query) {
      ...
      case 'D+':
        [
          ...
          cube[4][6], cube[2][0], cube[2][1], cube[2][2], cube[5][2],
          cube[4][3], cube[2][3],             cube[2][5], cube[5][5],
          cube[4][0], cube[2][6], cube[2][7], cube[2][8], cube[5][8],
      ...
      case 'L+':
        [
          ...
          [
            ...
            cube[1][6], cube[4][2], cube[4][5], cube[4][8], cube[3][0],
            cube[1][3], cube[4][1],             cube[4][7], cube[3][3],
            cube[1][0], cube[4][0], cube[4][3], cube[4][6], cube[3][6],
      ...
      case 'U-':
        ...
        case 'F-':
          [
                        cube[3][6], cube[3][7], cube[3][8],
            cube[4][2], cube[1][0], cube[1][1], cube[1][2], cube[5][0],
            cube[4][5], cube[1][3],             cube[1][5], cube[5][3],
            cube[4][8], cube[1][6], cube[1][7], cube[1][8], cube[5][6],
                        cube[1][0], cube[1][1], cube[1][2],
          ] =
            [
                          cube[5][0], cube[5][3], cube[5][6],
              cube[3][8], cube[1][2], cube[1][5], cube[1][8], cube[1][2],
              cube[3][7], cube[1][1],             cube[1][7], cube[1][1],
              cube[3][6], cube[1][0], cube[1][3], cube[1][6], cube[1][0],
                          cube[4][2], cube[4][5], cube[4][8],
            ]
          break;
      case 'D-':
        [
          ...
          [
            ...
            cube[1][8], cube[2][6], cube[2][3], cube[2][0], cube[3][2],
            cube[1][7], cube[2][7],             cube[2][1], cube[3][1],
            cube[1][6], cube[2][8], cube[2][5], cube[2][2], cube[3][0],
      ...
      case 'B-':
        [
          ...
          [
            ...
            cube[2][8], cube[3][6], cube[3][3], cube[3][0], cube[0][2],
            cube[2][7], cube[3][7],             cube[3][1], cube[0][1],
            cube[2][6], cube[3][8], cube[3][5], cube[3][2], cube[0][8],
